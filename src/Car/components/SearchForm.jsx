...
import { fetchData, editCriteria } from "../../store/actions/fetchData";
import SearchFormRadio from "./Search/SearchFormRadio";
import Slider from "./Search/Slider";
import DropdownInput from "./Search/DropdownInput";
                ...
                return Object.keys(this.props.metadata.aggregations[type]).map(e => {
                    return {
                        ...
                        text: `${e.substring(0, 1).toUpperCase() +
                            e.substring(1, e.length)} (${this.props.metadata.aggregations[type][e]
